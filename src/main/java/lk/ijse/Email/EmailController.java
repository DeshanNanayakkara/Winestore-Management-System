...
public class EmailController {
        public static void sendEmail(String email, int otp) throws MessagingException {
            ...
            String username = "deshannanayakkara12345@gmail.com";
            String password = "xvlp xviq jybz jayb"; // Use your actual App Password here
            ...
            String htmlboady =  "<html>\n" +
                    ...
                    "<body>\n" +
                    "    <div class=\"container\">\n" +
                    "        <h1>Here's your WineCafe OTP code, @" + email + "!</h1>\n" +
